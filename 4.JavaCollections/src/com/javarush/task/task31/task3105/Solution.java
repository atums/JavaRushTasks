...
public class Solution {
    public static void main(String[] args) throws IOException {
        // Да хз, что ему надо пишет : Убедись, что содержимое всех файлов в архиве осталось прежним. Где в нижнем коде проверка!!!
//        String fileName = args[0];
//        String zipArch = args[1];
//        Path pathZip = Paths.get(zipArch);
//        ConcurrentHashMap<String, ByteArrayOutputStream> hashMap = new ConcurrentHashMap<>();
//
//        try(ZipInputStream inputStream = new ZipInputStream(Files.newInputStream(pathZip))) {
//            ZipEntry entry;
...
//                }
//                hashMap.put(entry.getName(), byteArrayOutputStream);
//            }
//        }
//        try(ZipOutputStream outputStream = new ZipOutputStream(Files.newOutputStream(pathZip))) {
