...
//            String str = null;
//            int idTemp;
//            // Читаем файл и находим максимальный id, присваеваем новый id
//            while(reader.ready()) {
...
//            reader.close();
//
//            // формируем строку и записываем в кoнец файла с новой строки
//            normalStr = id + args[1] + args[2] + args[3];
//
//            BufferedWriter writer = new BufferedWriter(new FileWriter(file));
//            writer.newLine();
//            writer.write(normalStr);
//            writer.close();
//        }
//    }
//}
